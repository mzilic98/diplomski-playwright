...
export class Categories {
  ...
  constructor(page: Page) {
    ...
    this.computers = page.getByRole('listitem').filter({ hasText: 'Computers Desktops Notebooks Accessories' }).getByRole('link', { name: 'Computers' });
    this.electronics = page.getByRole('listitem').filter({ hasText: 'Electronics Camera, photo Cell phones' }).getByRole('link', { name: 'Electronics' });
    this.apparelAndShoes = page.getByRole('list').filter({ hasText: 'Books Computers Desktops Notebooks Accessories Electronics Camera, photo Cell ph' }).getByRole('link', { name: 'Apparel & Shoes' });
    this.digitalDownloads = page.getByRole('list').filter({ hasText: 'Books Computers Desktops Notebooks Accessories Electronics Camera, photo Cell ph' }).getByRole('link', { name: 'Digital downloads' });
    this.jewelry = page.getByRole('list').filter({ hasText: 'Books Computers Desktops Notebooks Accessories Electronics Camera, photo Cell ph' }).getByRole('link', { name: 'Jewelry' });
    this.giftcards = page.getByRole('list').filter({ hasText: 'Books Computers Desktops Notebooks Accessories Electronics Camera, photo Cell ph' }).getByRole('link', { name: 'Gift Cards' });
    this.cellphones = page.getByRole('heading', { name: 'Cell phones' }).getByRole('link', { name: 'Cell phones' });
