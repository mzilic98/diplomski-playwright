...
export class Shopping_cart {
  ...
  constructor(page: Page) {
    ...
    this.removeCheckbox = page.getByRole('row', { name: 'Picture of 3rd Album 3rd Album 1.00 1.00' }).getByRole('checkbox');
    ...
    this.firstItemPrice = page.getByRole('row', { name: 'Picture of 3rd Album 3rd Album 1.00 1.00' }).getByText('Total: 1.00');
