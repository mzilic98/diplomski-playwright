...
test.describe("Verify that the product behavior of the Demo web shop page work as intended", () => {
  ...
  test("TEST 1 Validating Essential Product Information", async () => {
  ...
  test("TEST 2 Verify that the user can change the quantity of the product", async ({
    page,
  }) => {
  ...
  test("TEST 2 Verify that the Add to cart button works as expected", async ({
    page,
  }) => {
  ...
  test("TEST 3 Verify that the Email a friend button on the product page is working correctly", async ({
    page,
  }) => {
  ...
  test("TEST 4 Verify that the Compare list button on the product page is working correctly", async ({
    page,
  }) => {
  ...
  test("TEST 5 Verify that the Add your Review link on the product page is clickable", async ({
    page,
  }) => {
